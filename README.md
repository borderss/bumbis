...
from the measured odds. Comparing only the balanced formats over 222 games:

| Format | Games | Win rate |
|---|---|---|
| 2v2 | 74 | 50.0 % |
| 2v2v2 | 101 | 33.3 % |

A single three-team win is exactly **1.50× rarer**. Lopsided shapes are excluded
from that comparison on purpose — a lone player in 1v2v2 wins about 8 %, which
would drag the three-team rate down for a reason that has nothing to do with how
many teams are on the pitch.
